...
export const SparkIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
        <rect width="40" height="40" rx="10" fill="url(#c_grad_main)" />
        <path d="M28 13C26.5 11.5 24.5 10.5 22 10.5C16.5 10.5 12 15 12 20.5C12 26 16.5 30.5 22 30.5C24.5 30.5 26.5 29.5 28 28" 
              stroke="white" 
              strokeWidth="4" 
              strokeLinecap="round" />
        <circle cx="29" cy="20.5" r="2.5" fill="white" />
        <defs>
            <linearGradient id="c_grad_main" x1="0" y1="0" x2="40" y2="40" gradientUnits="userSpaceOnUse">
...
export const TrendingDownIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
    <img src="/trending_down_icon.png" alt="" className={`${className} object-contain flex-shrink-0`} />
);
...
export const TargetIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <img src="/target_icon.png" alt="" className={`${className} object-contain flex-shrink-0`} />
);

export const PerformanceIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
...
export const RefreshIcon = ({ className = "w-5 h-5" }: { className?: string }) => (
    <img src="/refresh_icon.png" alt="" className={`${className} object-contain flex-shrink-0`} />
);

export const LogoIcon = ({ className = "w-8 h-8" }: { className?: string }) => (
    <svg className={className} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="40" height="40" rx="8" fill="#4338CA"/>
        <path d="M22.5361 12.3218L21.4648 15.5361L20.3936 12.3218L17.1793 11.2505L20.3936 10.1793L21.4648 6.96496L22.5361 10.1793L25.7504 11.2505L22.5361 12.3218Z" fill="white"/>
        <path d="M30.3929 20.3214L29.6429 22.5714L28.8929 20.3214L26.6429 19.5714L28.8929 18.8214L29.6429 16.5714L30.3929 18.8214L32.6429 19.5714L30.3929 20.3214Z" fill="white"/>
        <path d="M14.6429 25.3214L13.8929 27.5714L13.1429 25.3214L10.8929 24.5714L13.1429 23.8214L13.8929 21.5714L14.6429 23.8214L16.8929 24.5714L14.6429 25.3214Z" fill="white"/>
    </svg>
);
...
export const DetailedFeedbackIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 0 0 6 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0 1 18 16.5h-2.25m-7.5 0h7.5m-7.5 0-1 3m8.5-3 1 3m0 0 .5 1.5m-.5-1.5h-9.5m0 0-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />
    </svg>
);

export const SmartAvatarIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.76 9.76 0 0 1-2.544-.337l-3.296 3.296a.75.75 0 0 1-1.06-1.06l3.296-3.296A9.76 9.76 0 0 1 3 12c0-4.556 4.03-8.25 9-8.25s9 3.694 9 8.25Z" />
    </svg>
);
